"""
Django settings for petroconsultores project.
"""
...
WSGI_APPLICATION = 'petroconsultores.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # El origen de tu app de React en desarrollo
    "http://127.0.0.1:3000",
]